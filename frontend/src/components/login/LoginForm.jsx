  ...
  const handleSubmit = (e) => {
    ...
    try {
      ...
      if (email === storedEmail && password === storedPassword) {
        ...
        window.alert("Email dan Password tidak Valid");
      }
    } catch (error) {
      window.alert("Terdapat kesalahan saat melakukan login" + error.message);
    }
  };
  return (
    <div className="block max-w p-16 bg-gray-100 mx-32 border shadow-xl border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className="text-white bg-[#E9615A] w-[500px] text-center mt-10 place-content-center hover:bg-[#F9D86C] focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
        >
          Masuk
        </button>
      </form>
