        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-5">
          ...
          <div className="h-auto max-w-full rounded-lg grid-col-1">
            <div className='grid grid-cols-6 gap-4'>
              <h1 className='col-span-4 mb-4 text-4xl font-extrabold tracking-tight leading-none text-dark md:text-5xl lg:text-6xl'>{selectedData.title}</h1>
              ...
              <h5 className='col-span-6 mb-4 text-4md font-bold text-gray-400 tracking-tight leading-none text-dark md:text-4md lg:text-6md'>{selectedData.desc}</h5>
              <div className='col-span-6 grid grid-cols-6 border-t'>
                <p className='col-span-6 m-2'>created in : <br/> {selectedData.created_in}</p>
              </div>
              <div className='col-span-6 grid grid-cols-6 border-t'>
                <p className='col-span-6 m-2'>Artist :</p>
                <p className='col-span-2 rounded-full bg-gray-900 text-white text-center'>{selectedData.artist_name}</p>
              </div>
            </div>
          </div>
        </div>
